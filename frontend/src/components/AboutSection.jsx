...
const AboutSection = ({ isVisible, stats }) => (
  <section id="about" className="py-32 bg-gradient-to-b from-black via-gray-900/30 to-black relative">
      ...
      <div className={`max-w-6xl mx-auto text-center transform transition-all duration-1000 ${isVisible.about ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-red-600/20 to-transparent p-8 rounded-3xl border border-red-600/30 backdrop-blur-sm">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">World-Class Experience</h3>
                    <p className="text-gray-400">Curated for maximum impact</p>
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-red-900/30 via-red-800/20 to-red-900/30 p-12 rounded-3xl border border-red-600/30 backdrop-blur-sm">
          <Quote className="w-16 h-16 text-red-600/50 mx-auto mb-6" />
          <blockquote className="text-2xl md:text-3xl font-light italic text-white leading-relaxed mb-6">
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
      <div className="absolute top-20 left-20 w-2 h-2 bg-red-600 rounded-full animate-ping delay-300"></div>
      <div className="absolute bottom-40 right-32 w-3 h-3 bg-red-500 rounded-full animate-ping delay-700"></div>
      <div className="absolute top-1/2 left-16 w-1 h-1 bg-red-400 rounded-full animate-ping delay-1000"></div>
    </div>
  </section>
);
